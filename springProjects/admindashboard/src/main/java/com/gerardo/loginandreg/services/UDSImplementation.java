...
@Service
public class UDSImplementation implements UserDetailsService {
	
	private UserRepository userRepo;
	
	public UDSImplementation (UserRepository userRepo) {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        userRepo.setLastSignIn(new Date(), user.getId());
